    ...
    return (
        <>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
                <div
                    className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 max-w-5xl w-full pointer-events-auto transform transition-all"
                ...
                >
                    ...
                    <div className="grid md:grid-cols-2">
                        ...
                        {/* Left: Content */}
                        <div className="bg-primary-dark p-12 relative">
...
// Hook to trigger modal on exit intent
export const useExitIntent = (callback: () => void) => {
    useEffect(() => {
        let triggered = false;
        let canTrigger = false;

        // Wait 3 seconds before allowing exit-intent trigger
        const timer = setTimeout(() => {
            canTrigger = true;
        }, 3000);

        const handleMouseLeave = (e: MouseEvent) => {
            if (e.clientY <= 0 && !triggered && canTrigger) {
                triggered = true;
                callback();
            }
        };
